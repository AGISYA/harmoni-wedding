        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="relative order-2 md:order-1">
            ...
            <Image
              ...
              width={800}
              height={600}
              className="rounded-xl sm:rounded-2xl shadow-xl object-cover relative z-10"
            />
            <div className="absolute -bottom-3 -right-3 sm:-bottom-4 sm:-right-4 bg-white p-2 sm:p-4 rounded-lg shadow-lg z-20">
              <div className="flex items-center gap-1 sm:gap-2">
                <Star className="h-3 w-3 sm:h-5 sm:w-5 text-yellow-500 fill-yellow-500" />
                <Star className="h-3 w-3 sm:h-5 sm:w-5 text-yellow-500 fill-yellow-500" />
                <Star className="h-3 w-3 sm:h-5 sm:w-5 text-yellow-500 fill-yellow-500" />
                <Star className="h-3 w-3 sm:h-5 sm:w-5 text-yellow-500 fill-yellow-500" />
                <Star className="h-3 w-3 sm:h-5 sm:w-5 text-yellow-500 fill-yellow-500" />
          ...
          <div className="space-y-4 sm:space-y-6 order-1 md:order-2">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4 pt-2 sm:pt-4">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  <p className="font-medium text-sm sm:text-base">Kapasitas</p>
            ...
            <Button
              ...
              variant="rose"
              rounded="full"
              className="gap-2 px-6 sm:px-8 mt-2 sm:mt-4 text-sm sm:text-base group"
            >
              Jelajahi Venue
...
function HistoryTimeline() {
  ...
  return (
    <div className="mt-12 sm:mt-16 text-gray-800 md:mt-20 bg-rose-50 rounded-xl sm:rounded-3xl p-4 sm:p-8 md:p-12">
          ...
          {timelineItems.map((item, index) => (
            ...
            >
              ...
              <div className="md:w-3/4">
                <h4 className="text-lg sm:text-xl font-medium mb-1 sm:mb-2">
                  {item.title}
                </h4>
