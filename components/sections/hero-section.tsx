...
export default function HeroSection({
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="container relative z-10 px-4 sm:px-6 py-16 sm:py-20 md:py-24 lg:py-36">
        <div className="max-w-xs sm:max-w-md md:max-w-lg lg:max-w-2xl space-y-4 sm:space-y-6 text-white">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-serif font-bold tracking-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2 sm:pt-4">
            <Button
              ...
              rounded="full"
              size="lg"
              className="gap-2 px-6 sm:px-8 py-5 sm:py-6 text-base sm:text-lg group"
            >
              Pesan Sekarang
            ...
            <Button
              ...
              rounded="full"
              size="lg"
              className="bg-white/10 backdrop-blur-sm text-white border-white/20 hover:bg-white/20 px-6 sm:px-8 py-5 sm:py-6 text-base sm:text-lg"
